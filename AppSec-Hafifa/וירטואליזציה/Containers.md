...
1. <div dir="rtl">**הContainer Runtime מקבל קריאה ליצור קונטיינר חדש עם הפנייה למיקום של הimage שלו ומאפיין יחודי מהContainer Engine.**</div>
2. <div dir="rtl">**Container Runtime קורא ומוודא את ההגדרות של הimage.**</div>
3. <div dir="rtl">**אחר כך קוראת ההקצאה של משאבים ,נקודות הmount ומרחב השמות תוך כדי פירוק ומיזוג של השכבות בimage , ככה הקונטיינר מוכן לרוץ (על ידי הENGINE).**</div>
4. <div dir="rtl">**אחר כך יוצרים תהליך חדש עם mount על הroot של מערכת הקבצים שלו כדי שיוכל לגשת רק למשאבים הנכונים במכסה שלו וההגדרות אבטחה הנכונות(על ידי הENGINE).**</div>
5. <div dir="rtl">**עכשיו ניתן להתחיל , עצור או למחוק את הקונטיינר , מחיקה תמחק גם את כל ההפניות לקונטיינר וינקה את מערכת הקבצים.**</div>
...
1. <div dir="rtl">כיצד ניתן לראות את כל הimageים של docker שקיימים על המכונה</div>
    - sudo docker images
2. <div dir="rtl">כיצד ניתן לראות את כל הcontainerים של docker שקיימים על המכונה</div>
    - sudo docker container ls -a
3. <div dir="rtl">כיצד ניתן לראות את כל הcontainerים של docker שפועלים כרגע על המכונה</div>
    - sudo docker container ls -a
4. <div dir="rtl">כיצד נכנס לקונטיינר שפועל בעזרת bash</div>
...
1. <div dir="rtl">איך ניתן להפעיל container בלי להכנס אוטומטית</div>
...
1. <div dir="rtl">נוכל להכנס לקונטיינר עצמו שפועל מבלי הצורך לפתוח עליו shell</div>
...
1. <div dir="rtl">עצירה ומחיקה של כל הcontainerים</div>
    - docker stop $(docker ps -a -q)
    - docker rm $(docker ps -a -q)

<div dir="rtl">משימה:</div>

1. <div dir="rtl">צור 2 קונטיינרי docker של WordPress ו1 MySQL בעוד ששני הקונטיינרים של WordPress ישתמשו בקונטיינר של MySQL בתוך DataBase</div>
2. <div dir="rtl">הוסף קונטיינר docker של nginx בתוך load balancer בין שני הקונטיינרים של הWordPress</div>
3. <div dir="rtl">צור קובץ docker-compose שיצור את המשימה הזאת לבדו</div>
...
1. <div dir="rtl">**Docker-ים , ו-Containers ועל הארכיטקטורה שלהם.**</div>
...
1. <div dir="rtl">**המנוע מושך את הimage לתוך הlocal cache ובכל פעם שמתחיל קוטיינר חדש המנוע אחראי למפות את הCoW של הimage של אותו הקונטיינר ולעתים קורובות מוסיף שכבה שהיא writeable לקונטיינר שיהיה אפשר לכתוב בה נתונים.**</div>
...
1. <div dir="rtl">**בכל פעם שמתחיל קונטיינר חדש , עותק וירטואלי שנוצר מהקבצים של הimage של הקונטיינר ממופה לתוך הקונטיינר , בדומה להקצאת מקום של VM ,במידה והקונטיינר הוא read-only זהו השלב האחרון של המנוע ,לעמות זאת אם זה non-read-only הוא אחראי גם למפות writable volume על גבי השכבות של הimage של הקונטיינר , כאשר נכתוב מידע לתוך הקונטיינר זה ירגיש כאילו אנחנו כותבים נתונים לתוכו אבל בעצם אנחנו רק כותבים נתונים לשכבת CoW של הimage.**</div>
